...
export function historicalFields(s:GameState){const {career:_career,...old}=s;return {...old,version:6,fleet:s.fleet.map(({tuning:_t,...p})=>p),orders:s.orders.map(({service:_s,product:_p,...o})=>o)};}
