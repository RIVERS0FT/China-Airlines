import { legacyEmployee } from '../src/core/organization.js';
...
describe("strict expanded schema", () => {
  ...
  const mutations: [string, (s: GameState) => void][] = [
    ...
    [
      ...
      (s) => {
        s.career.employees = [
          legacyEmployee({ id: 1, name: "a", paidUntil: 100, skill: 0, planeId: null }, s.simTime),
          legacyEmployee({ id: 1, name: "b", paidUntil: 100, skill: 0, planeId: null }, s.simTime),
        ];
        s.career.nextId = 2;
      },
    ],
