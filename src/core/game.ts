...
function depart(s: GameState, p: Plane, to: string, auto: boolean) {
  ...
  spend(s, q.cost); p.energy.availableSeconds -= energyRequired(q.duration); p.energy.reservedSeconds = q.duration; s.stats.costs += q.cost; p.autoRouteId = auto ? id : null;
