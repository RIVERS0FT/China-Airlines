...
import { WORLD_AIRPORTS, type AirportDefinition } from './world-airports-v7.js';
...
export { MODELS, STARTER_MODEL, ALL_MODELS, AIRCRAFT_KIND_LABEL, UPGRADE_LABEL, emptyUpgrades, aircraftSpecs, retrofitPrice,
  hangarPrice, TASKS, model, routeId, upgradePrice } from './career-catalog-v7.js';
export type { AircraftKind, AircraftModel, UpgradeKey, Upgrades } from './career-catalog-v7.js';
export { CONTINENTS, type Continent, type AirportDefinition } from './world-airports-v7.js';
