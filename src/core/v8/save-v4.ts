// Frozen v0.4 validator after ordered-route main abc4d17; accepts both v4 route histories. Never execute current simulation here.
import { aircraftSpecs, emptyUpgrades, UPGRADE_LABEL, type Upgrades, model, routeId, TASKS, distance } from './catalog-v4.js';
