...
import { WORLD_AIRPORTS, type AirportDefinition } from './world-airports-v6.js';
...
export { CONTINENTS, type Continent, type AirportDefinition } from './world-airports-v6.js';
