...
export function Network({ game, plane, destination, setDestination, onReturn, onDepart, busy }: {
  ...
  const inFlight = Boolean(plane?.flight), cooling = plane && (game.simTime < plane.readyAt || plane.itinerary.length > 0 || Boolean(plane.autoRouteId));
